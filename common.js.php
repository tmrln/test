...
function COMPANIES_validateData(){
	...
	if($j('#GPRKEY').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> GPRKEY", close: function(){ $j('[name=GPRKEY]').focus(); $j('[name=GPRKEY]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function ARTICLES_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#ARTKEY').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> ARTKEY", close: function(){ $j('[name=ARTKEY]').focus(); $j('[name=ARTKEY]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function INVOICEVALUES_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#INV_GPRKEY').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> INV GPRKEY", close: function(){ $j('[name=INV_GPRKEY]').focus(); $j('[name=INV_GPRKEY]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function FORECASTVALUES_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#FOR_GPRKEY').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> FOR GPRKEY", close: function(){ $j('[name=FOR_GPRKEY]').focus(); $j('[name=FOR_GPRKEY]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
