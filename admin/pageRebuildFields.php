<?php
	...
	$schema = array(   
		'COMPANIES' => array(   
			'CLTNAM' => array('appgini' => 'VARCHAR(40) '),
			'GPRKEY' => array('appgini' => 'VARCHAR(40) not null primary key '),
			'GPRNAM' => array('appgini' => 'VARCHAR(40) '),
			'GPRSAM' => array('appgini' => 'VARCHAR(40) '),
			'GPRSTT' => array('appgini' => 'VARCHAR(40) '),
			'KSTNRA' => array('appgini' => 'VARCHAR(40) '),
			'KSTNAM' => array('appgini' => 'VARCHAR(40) ')
		),
		'ARTICLES' => array(   
			'ARTKEY' => array('appgini' => 'VARCHAR(40) not null primary key '),
			'ARTNAM' => array('appgini' => 'VARCHAR(40) '),
			'ATYNAM' => array('appgini' => 'VARCHAR(40) '),
			'AGRNAM' => array('appgini' => 'VARCHAR(40) ')
		),
		'INVOICEVALUES' => array(   
			'CLTNAM' => array('appgini' => 'VARCHAR(40) '),
			'INV_GPRKEY' => array('appgini' => 'VARCHAR(40) not null primary key '),
			'INV_GPRNAM' => array('appgini' => 'VARCHAR(40) '),
			'INV_ARTKEY' => array('appgini' => 'VARCHAR(40) '),
			'INV_ARTNAM' => array('appgini' => 'VARCHAR(40) '),
			'INVMEN' => array('appgini' => 'VARCHAR(40) '),
			'INVMON_F' => array('appgini' => 'VARCHAR(40) '),
			'INVJAH_F' => array('appgini' => 'VARCHAR(40) ')
		),
		'FORECASTVALUES' => array(   
			'CLTNAM' => array('appgini' => 'VARCHAR(40) '),
			'FOR_ARTKEY' => array('appgini' => 'VARCHAR(40) '),
			'FOR_GPRKEY' => array('appgini' => 'VARCHAR(40) not null primary key '),
			'FOR_ADRKEY' => array('appgini' => 'VARCHAR(40) '),
			'FORMEN' => array('appgini' => 'VARCHAR(40) '),
			'FORMON_F' => array('appgini' => 'VARCHAR(40) '),
			'FORJAH_F' => array('appgini' => 'VARCHAR(40) '),
			'KSTNRA' => array('appgini' => 'VARCHAR(40) ')
		)
	);
